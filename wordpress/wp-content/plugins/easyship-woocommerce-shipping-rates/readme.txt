...
Contributors: goeasyship, sunnycyk, alohachen, paulld, berniechiu, CarlosLongarela
...
The plugin is tested on WordPress version 4.4 to 6.3.2

= What WooCommerce version does the plugin support? =

The plugin is tested on WooCommerce version 2.4 to 8.2.1
