...
class Yaml implements ParserInterface
{
    ...
    public function parseFile($filename)
    {
        try {
            ...
            throw new ParseException(['message' => 'Error parsing YAML file', 'exception' => $exception]);
        }
    ...
    public function parseString($config)
    {
        try {
            ...
            throw new ParseException(['message' => 'Error parsing YAML string', 'exception' => $exception]);
        }
        return (array) $this->parse($data);
    }
    /**
