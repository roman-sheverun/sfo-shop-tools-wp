...
class Php implements ParserInterface
{
    ...
    public function parseFile($filename)
    {
        ...
        try {
            ...
            throw new ParseException(['message' => 'PHP file threw an exception', 'exception' => $exception]);
        }
        // Complete parsing
    ...
    public function parseString($config)
    {
        ...
        try {
            ...
            throw new ParseException(['message' => 'PHP string threw an exception', 'exception' => $exception]);
        }
        // Complete parsing
