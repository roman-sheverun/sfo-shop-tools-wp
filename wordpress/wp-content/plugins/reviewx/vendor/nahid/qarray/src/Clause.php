...
class Clause
{
    ...
    {
        $properties = ['_data' => [], '_original' => [], '_select' => [], '_isProcessed' => \false, '_node' => '', '_except' => [], '_conditions' => [], '_take' => null, '_offset' => 0, '_traveler' => '.'];
    ...
    protected function makeWhere($key, $condition = null, $value = null)
    {
        ...
        \array_push($current, ['key' => $key, 'condition' => $condition, 'value' => $value]);
