...
class PluginBuildCommand extends BaseCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (!\file_exists(WPDRILL_ROOT_PATH . '/php-scoper')) {
            $output->writeln(['<error>No php-scoper executable file available</error>']);
        ...
        $io->newLine();
        $output->writeln(['<comment>Build Name: ' . $buildName . '</comment>', '<comment>Time: ' . $totalTime . ' Seconds</comment>']);
