...
class Response extends \WP_REST_Response
{
    ...
    public function success(string $message = '', int $httpCode = self::HTTP_OK, ?int $code = null) : self
    {
    ...
    public function fails(string $message = '', int $httpCode = Response::HTTP_BAD_REQUEST, ?int $code = null) : self
    {
        $this->httpCode = $httpCode;
        /**
         * @var int $code
