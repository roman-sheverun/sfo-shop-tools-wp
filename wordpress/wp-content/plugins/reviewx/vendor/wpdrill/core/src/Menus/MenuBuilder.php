...
class MenuBuilder
{
    ...
    public function register()
    {
        ...
        foreach ($this->menus as $menu) {
            if ($menu->hasParent()) {
                add_submenu_page($menu->getParentSlug(), $menu->getPageTitle(), $menu->getName(), $menu->getCapability(), $menu->getSlug(), $menu->getHandler(), $menu->getPosition());
            } else {
                add_menu_page($menu->getPageTitle(), $menu->getName(), $menu->getCapability(), $menu->getSlug(), $menu->getHandler(), $menu->getIcon(), $menu->getPosition());
            }
        }
    }
