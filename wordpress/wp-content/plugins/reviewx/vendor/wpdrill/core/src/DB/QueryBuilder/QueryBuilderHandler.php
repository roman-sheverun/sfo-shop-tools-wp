...
class QueryBuilderHandler
{
    ...
    /**
     * @param null|\WPDrill\DB\Connection $connection
     *
     * @throws \WPDrill\DB\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build($this->adapter, array($this->connection));
    }
    /**
     * Set the fetch mode
     *
    ...
    public function get()
    {
        ...
        $executionTime = \microtime(\true) - $start;
    ...
    {
        $this->select($fields);
        $this->addStatement('distinct', \true);
        return $this;
    }
    /**
     * @param $field
     ...
     * @return array|mixed
     */
    public function addTablePrefix($values, $tableFieldMix = \true)
    {
    ...
    public function paginate($perPage = null, $columns = array('*'))
    {
        ...
        return array('current_page' => $currentPage, 'per_page' => $perPage, 'from' => $from, 'to' => $to, 'last_page' => $lastPage, 'total' => $total, 'data' => $data);
    }
    /**
