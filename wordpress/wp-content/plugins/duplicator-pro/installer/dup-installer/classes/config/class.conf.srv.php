...
class DUPX_ServerConfig
{
    ...
    {
        return DUPX_Orig_File_Manager::getInstance()->getEntryStoredPath(self::CONFIG_ORIG_FILE_WPCONFIG_ID_OVERWRITE_SITE);
    }
    ...
    {
        return DUPX_Orig_File_Manager::getInstance()->getEntryStoredPath(self::CONFIG_ORIG_FILE_WPCONFIG_ID);
    }
