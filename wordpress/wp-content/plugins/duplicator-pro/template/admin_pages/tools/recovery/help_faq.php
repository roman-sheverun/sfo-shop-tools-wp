...
<p>
    ...
    <?php
    _e(
        'In short, yes. If you are performing a potentially destructive operation you should not only create a Recovery Point, ' .
        'but you should also save the Recovery URL associated with the Recovery Point.',
        'duplicator-pro'
    ); ?>
</p>
