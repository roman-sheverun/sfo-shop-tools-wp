...
>
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                <input 
                    type="radio" name="json_mode" id="json_mode_php" value="<?php echo DUP_PRO_JSON_Mode::PHP; ?>" 
                    <?php checked($global->json_mode, DUP_PRO_JSON_Mode::PHP); ?> />
                <label for="json_mode_php"><?php DUP_PRO_U::esc_html_e("PHP"); ?></label> &nbsp;
                <input
                    type="radio" name="json_mode" id="json_mode_custom" value="<?php echo DUP_PRO_JSON_Mode::Custom; ?>" 
                    <?php checked($global->json_mode, DUP_PRO_JSON_Mode::Custom); ?> />
                <label for="json_mode_custom"><?php DUP_PRO_U::esc_html_e("Custom"); ?></label> &nbsp;
            </td>
        </tr>
        <tr valign="top">
